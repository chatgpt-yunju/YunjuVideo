...
import com.flj.latte.ec.main.music.MusicDelegate;
import com.flj.latte.ec.main.personal.PersonalDelegate;
import com.flj.latte.ec.main.sort.SortDelegate;
import com.flj.latte.ec.main.video.VideoDelegate;
import com.flj.latte.ec.main.video.VideoDelegate1;
...
public class EcBottomDelegate extends BaseBottomDelegate {
    ...
    public LinkedHashMap<BottomTabBean, BottomItemDelegate> setItems(ItemBuilder builder) {
        ...
        items.put(new BottomTabBean("{fa-play}", "视频"), new VideoDelegate());
